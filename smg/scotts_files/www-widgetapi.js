...
function w(a,b){a.prototype=ja(b.prototype);a.prototype.constructor=a;if(oa)oa(a,b);else for(var c in b)if("prototype"!=c)if(Object.defineProperties){var d=Object.getOwnPropertyDescriptor(b,c);d&&Object.defineProperty(a,c,d)}else a[c]=b[c];a.A=b.prototype}
function pa(){this.l=!1;this.h=null;this.o=void 0;this.g=1;this.i=this.j=0;this.v=this.f=null}
function qa(a){if(a.l)throw new TypeError("Generator is already running");a.l=!0}
pa.prototype.m=function(a){this.o=a};
function ta(a,b){a.f={la:b,X:!0};a.g=a.j||a.i}
pa.prototype["return"]=function(a){this.f={"return":a};this.g=this.i};
...
function za(a){var b=a.v.splice(0)[0];(b=a.f=a.f||b)?b.X?a.g=a.j||a.i:void 0!=b.S&&a.i<b.S?(a.g=b.S,a.f=null):a.g=a.i:a.g=4}
function Da(a){this.f=new pa;this.g=a}
function Ea(a,b){qa(a.f);var c=a.f.h;if(c)return Ga(a,"return"in c?c["return"]:function(d){return{value:d,done:!0}},b,a.f["return"]);
a.f["return"](b);return Ha(a)}
function Ga(a,b,c,d){try{var e=b.call(a.f.h,c);if(!(e instanceof Object))throw new TypeError("Iterator result "+e+" is not an object");if(!e.done)return a.f.l=!1,e;var f=e.value}catch(g){return a.f.h=null,ta(a.f,g),Ha(a)}a.f.h=null;d.call(a.f,f);return Ha(a)}
function Ha(a){for(;a.f.g;)try{var b=a.g(a.f);if(b)return a.f.l=!1,{value:b.value,done:!1}}catch(c){a.f.o=void 0,ta(a.f,c)}a.f.l=!1;if(a.f.f){b=a.f.f;a.f.f=null;if(b.X)throw b.la;return{value:b["return"],done:!0}}return{value:void 0,done:!0}}
function Ia(a){this.next=function(b){qa(a.f);a.f.h?b=Ga(a,a.f.h.next,b,a.f.m):(a.f.m(b),b=Ha(a));return b};
this["throw"]=function(b){qa(a.f);a.f.h?b=Ga(a,a.f.h["throw"],b,a.f.m):(ta(a.f,b),b=Ha(a));return b};
this["return"]=function(b){return Ea(a,b)};
this[Symbol.iterator]=function(){return this}}
function Ja(a,b){var c=new Ia(new Da(b));oa&&a.prototype&&oa(c,a.prototype);return c}
...
var Qa="closure_uid_"+(1E9*Math.random()>>>0),Ra=0;function Va(a,b,c){return a.call.apply(a.bind,arguments)}
...
D(ab,Error);ab.prototype.name="CustomError";var bb=Array.prototype.indexOf?function(a,b){return Array.prototype.indexOf.call(a,b,void 0)}:function(a,b){if("string"===typeof a)return"string"!==typeof b||1!=b.length?-1:a.indexOf(b,0);
...
;var Fb;a:{var Gb=z.navigator;if(Gb){var Hb=Gb.userAgent;if(Hb){Fb=Hb;break a}}Fb=""}function G(a){return-1!=Fb.indexOf(a)}
;function Ib(){}
;function Jb(a){Jb[" "](a);return a}
Jb[" "]=Na;var Kb=G("Opera"),Lb=G("Trident")||G("MSIE"),Mb=G("Edge"),Nb=G("Gecko")&&!(-1!=Fb.toLowerCase().indexOf("webkit")&&!G("Edge"))&&!(G("Trident")||G("MSIE"))&&!G("Edge"),Ob=-1!=Fb.toLowerCase().indexOf("webkit")&&!G("Edge");function Pb(){var a=z.document;return a?a.documentMode:void 0}
var Qb;a:{var Rb="",Sb=function(){var a=Fb;if(Nb)return/rv:([^\);]+)(\)|;)/.exec(a);if(Mb)return/Edge\/([\d\.]+)/.exec(a);if(Lb)return/\b(?:MSIE|rv)[: ]([^\);]+)(\)|;)/.exec(a);if(Ob)return/WebKit\/(\S+)/.exec(a);if(Kb)return/(?:Version)[ \/]?(\S+)/.exec(a)}();
Sb&&(Rb=Sb?Sb[1]:"");if(Lb){var Tb=Pb();if(null!=Tb&&Tb>parseFloat(Rb)){Qb=String(Tb);break a}}Qb=Rb}var Ub=Qb,Vb={},Wb;if(z.document&&Lb){var Xb=Pb();Wb=Xb?Xb:parseInt(Ub,10)||void 0}else Wb=void 0;var Yb=Wb;var Zb=G("Firefox")||G("FxiOS"),$b=G("iPhone")&&!G("iPod")&&!G("iPad")||G("iPod"),jc=G("iPad");var kc={},lc=null;var H=window;function mc(a){var b=A("window.location.href");null==a&&(a='Unknown Error of type "null/undefined"');if("string"===typeof a)return{message:a,name:"Unknown error",lineNumber:"Not available",fileName:b,stack:"Not available"};var c=!1;try{var d=a.lineNumber||a.line||"Not available"}catch(g){d="Not available",c=!0}try{var e=a.fileName||a.filename||a.sourceURL||z.$googDebugFname||b}catch(g){e="Not available",c=!0}b=nc(a);if(!(!c&&a.lineNumber&&a.fileName&&a.stack&&a.message&&a.name)){c=a.message;if(null==
...
return a}
var Ec={za:"allow-forms",Aa:"allow-modals",Ba:"allow-orientation-lock",Ca:"allow-pointer-lock",Da:"allow-popups",Ea:"allow-popups-to-escape-sandbox",Fa:"allow-presentation",Ga:"allow-same-origin",Ha:"allow-scripts",Ia:"allow-top-navigation",Ja:"allow-top-navigation-by-user-activation"},Gc=ib(function(){return Fc()});
...
function b(n){for(var r=g,q=0;64>q;q+=4)r[q/4]=n[q]<<24|n[q+1]<<16|n[q+2]<<8|n[q+3];for(q=16;80>q;q++)n=r[q-3]^r[q-8]^r[q-14]^r[q-16],r[q]=(n<<1|n>>>31)&4294967295;n=e[0];var x=e[1],v=e[2],F=e[3],Fa=e[4];for(q=0;80>q;q++){if(40>q)if(20>q){var P=F^x&(v^F);var va=1518500249}else P=x^v^F,va=1859775393;else 60>q?(P=x&v|F&(x|v),va=2400959708):(P=x^v^F,va=3395469782);P=((n<<5|n>>>27)&4294967295)+P+Fa+va+r[q]&4294967295;Fa=F;F=v;v=(x<<30|x>>>2)&4294967295;x=n;n=P}e[0]=e[0]+n&4294967295;e[1]=e[1]+x&4294967295;
e[2]=e[2]+v&4294967295;e[3]=e[3]+F&4294967295;e[4]=e[4]+Fa&4294967295}
...
function Tc(a){-1==a.f&&(a.f=cb(a.g,function(b,c,d){return c?b+Math.pow(2,d):b},0));
return a.f}
...
var Xc;function Yc(){var a=z.MessageChannel;"undefined"===typeof a&&"undefined"!==typeof window&&window.postMessage&&window.addEventListener&&!G("Presto")&&(a=function(){var e=uc();e.style.display="none";document.documentElement.appendChild(e);var f=e.contentWindow;e=f.document;e.open();e.close();var g="callImmediate"+Math.random(),h="file:"==f.location.protocol?"*":f.location.protocol+"//"+f.location.host;e=Xa(function(k){if(("*"==h||k.origin==h)&&k.data==g)this.port1.onmessage()},this);
...
function Id(a){if(Oa(a))return gb(a);a=Gd(a);var b=[];Hd(a,function(c){b.push(c)});
return b}
...
if(Od=Lb){var Pd;if(Object.prototype.hasOwnProperty.call(Vb,"9"))Pd=Vb["9"];else{for(var Qd=0,Rd=wb(String(Ub)).split("."),Sd=wb("9").split("."),Td=Math.max(Rd.length,Sd.length),Ud=0;0==Qd&&Ud<Td;Ud++){var Vd=Rd[Ud]||"",Wd=Sd[Ud]||"";do{var Xd=/(\d*)(\D*)(.*)/.exec(Vd)||["","","",""],Yd=/(\d*)(\D*)(.*)/.exec(Wd)||["","","",""];if(0==Xd[0].length&&0==Yd[0].length)break;Qd=Eb(0==Xd[1].length?0:parseInt(Xd[1],10),0==Yd[1].length?0:parseInt(Yd[1],10))||Eb(0==Xd[2].length,0==Yd[2].length)||Eb(Xd[2],Yd[2]);
...
function je(a,b){var c=b.type;c in a.listeners&&eb(a.listeners[c],b)&&(ge(b),0==a.listeners[c].length&&(delete a.listeners[c],a.f--))}
...
return a[ze]}
;function I(){Ic.call(this);this.f=new he(this);this.l=this;this.j=null}
D(I,Ic);I.prototype[de]=!0;I.prototype.addEventListener=function(a,b,c,d){ne(this,a,b,c,d)};
I.prototype.removeEventListener=function(a,b,c,d){ve(this,a,b,c,d)};
I.prototype.dispatchEvent=function(a){var b=this.j;if(b){var c=[];for(var d=1;b;b=b.j)c.push(b),++d}b=this.l;d=a.type||a;if("string"===typeof a)a=new ae(a,b);else if(a instanceof ae)a.target=a.target||b;else{var e=a;a=new ae(d,b);ub(a,e)}e=!0;if(c)for(var f=c.length-1;!a.g&&0<=f;f--){var g=a.f=c[f];e=Ae(g,d,!0,a)&&e}a.g||(g=a.f=b,e=Ae(g,d,!0,a)&&e,a.g||(e=Ae(g,d,!1,a)&&e));if(c)for(f=0;!a.g&&f<c.length;f++)g=a.f=c[f],e=Ae(g,d,!1,a)&&e;return e};
I.prototype.H=function(){I.A.H.call(this);if(this.f){var a=this.f,b=0,c;for(c in a.listeners){for(var d=a.listeners[c],e=0;e<d.length;e++)++b,ge(d[e]);delete a.listeners[c];a.f--}}this.j=null};
...
;var Be=z.JSON.stringify;function J(a){this.f=0;this.m=void 0;this.i=this.g=this.h=null;this.j=this.l=!1;if(a!=Na)try{var b=this;a.call(void 0,function(c){Ce(b,2,c)},function(c){Ce(b,3,c)})}catch(c){Ce(this,3,c)}}
...
function Ge(a,b,c){He(a,b,c,null)||bd(Ya(b,a))}
function Ie(a){return new J(function(b,c){var d=a.length,e=[];if(d)for(var f=function(l,m){d--;e[l]=m;0==d&&b(e)},g=function(l){c(l)},h=0,k;h<a.length;h++)k=a[h],Ge(k,Ya(f,h),g);
else b(e)})}
J.prototype.then=function(a,b,c){return Je(this,"function"===typeof a?a:null,"function"===typeof b?b:null,c)};
J.prototype.$goog_Thenable=!0;function Ke(a,b){return Je(a,null,b,void 0)}
J.prototype.cancel=function(a){if(0==this.f){var b=new Le(a);bd(function(){Me(this,b)},this)}};
...
function Je(a,b,c,d){var e=Fe(null,null,null);e.f=new J(function(f,g){e.g=b?function(h){try{var k=b.call(d,h);f(k)}catch(l){g(l)}}:f;
e.onRejected=c?function(h){try{var k=c.call(d,h);void 0===k&&h instanceof Le?g(h):f(k)}catch(l){g(l)}}:g});
e.f.h=a;Pe(a,e);return e.f}
J.prototype.v=function(a){this.f=0;Ce(this,2,a)};
J.prototype.G=function(a){this.f=0;Ce(this,3,a)};
...
function He(a,b,c,d){if(a instanceof J)return Pe(a,Fe(b||Na,c||null,d)),!0;if(a)try{var e=!!a.$goog_Thenable}catch(g){e=!1}else e=!1;if(e)return a.then(b,c,d),!0;if(B(a))try{var f=a.then;if("function"===typeof f)return Se(a,f,b,c,d),!0}catch(g){return c.call(d,g),!0}return!1}
...
J.prototype.o=function(){for(var a;a=Ne(this);)Oe(this,a,this.f,this.m);this.l=!1};
...
var Ue=Wc;function Le(a){ab.call(this,a)}
D(Le,ab);Le.prototype.name="cancel";function K(a){Ic.call(this);this.m=1;this.j=[];this.l=0;this.f=[];this.g={};this.o=!!a}
D(K,Ic);p=K.prototype;p.subscribe=function(a,b,c){var d=this.g[a];d||(d=this.g[a]=[]);var e=this.m;this.f[e]=a;this.f[e+1]=b;this.f[e+2]=c;this.m=e+3;d.push(e);return e};
function Ve(a,b,c){var d=We;if(a=d.g[a]){var e=d.f;(a=db(a,function(f){return e[f+1]==b&&e[f+2]==c}))&&d.O(a)}}
p.O=function(a){var b=this.f[a];if(b){var c=this.g[b];0!=this.l?(this.j.push(a),this.f[a+1]=Na):(c&&eb(c,a),delete this.f[a],delete this.f[a+1],delete this.f[a+2])}return!!b};
...
p.H=function(){K.A.H.call(this);this.clear();this.j.length=0};function Ye(a){this.f=a}
...
function sf(a){var b=A("yt.logging.errors.log");b?b(a,"ERROR",void 0,void 0,void 0):(b=L("ERRORS",[]),b.push([a,"ERROR",void 0,void 0,void 0]),of("ERRORS",b))}
function tf(a){var b=A("yt.logging.errors.log");b?b(a,"WARNING",void 0,void 0,void 0):(b=L("ERRORS",[]),b.push([a,"WARNING",void 0,void 0,void 0]),of("ERRORS",b))}
...
wf.prototype.stopImmediatePropagation=function(){this.event&&(this.event.cancelBubble=!0,this.event.stopImmediatePropagation&&this.event.stopImmediatePropagation())};var lb=z.ytEventsEventsListeners||{};C("ytEventsEventsListeners",lb);var xf=z.ytEventsEventsCounter||{count:0};C("ytEventsEventsCounter",xf);
function yf(a,b,c,d){d=void 0===d?{}:d;a.addEventListener&&("mouseenter"!=b||"onmouseenter"in document?"mouseleave"!=b||"onmouseenter"in document?"mousewheel"==b&&"MozBoxSizing"in document.documentElement.style&&(b="MozMousePixelScroll"):b="mouseout":b="mouseover");return kb(function(e){var f="boolean"===typeof e[4]&&e[4]==!!d,g=B(e[4])&&B(d)&&mb(e[4],d);return!!e.length&&e[0]==a&&e[1]==b&&e[2]==c&&(f||g)})}
function zf(a){a&&("string"==typeof a&&(a=[a]),E(a,function(b){if(b in lb){var c=lb[b],d=c[0],e=c[1],f=c[3];c=c[4];d.removeEventListener?Af()||"boolean"===typeof c?d.removeEventListener(e,f,c):d.removeEventListener(e,f,!!c.capture):d.detachEvent&&d.detachEvent("on"+e,f);delete lb[b]}}))}
var Af=ib(function(){var a=!1;try{var b=Object.defineProperty({},"capture",{get:function(){a=!0}});
...
g=rf(g);a.addEventListener?("mouseenter"==b&&f?b="mouseover":"mouseleave"==b&&f?b="mouseout":"mousewheel"==b&&"MozBoxSizing"in document.documentElement.style&&(b="MozMousePixelScroll"),Af()||"boolean"===typeof d?a.addEventListener(b,g,d):a.addEventListener(b,g,!!d.capture)):a.attachEvent("on"+b,g);lb[e]=[a,b,c,g,d]}}}
...
;var Ef={q:!0,search_query:!0};function Ff(a){var b=[];jb(a,function(c,d){var e=encodeURIComponent(String(d)),f;Array.isArray(c)?f=c:f=[c];E(f,function(g){""==g?b.push(e):b.push(e+"="+encodeURIComponent(String(g)))})});
return b.join("&")}
function Gf(a){"?"==a.charAt(0)&&(a=a.substr(1));for(var b=a.split("&"),c={},d=0,e=b.length;d<e;d++){var f=b[d].split("=");if(1==f.length&&f[0]||2==f.length)try{var g=decodeURIComponent((f[0]||"").replace(/\+/g," ")),h=decodeURIComponent((f[1]||"").replace(/\+/g," "));g in c?Array.isArray(c[g])?hb(c[g],h):c[g]=[c[g],h]:c[g]=h}catch(k){Ef.hasOwnProperty(f[0])||(k.args=[{key:f[0],value:f[1],query:a}],sf(k))}}return c}
...
;var Kf={},Lf=[],We=new K,Mf={};function Nf(){for(var a=u(Lf),b=a.next();!b.done;b=a.next())b=b.value,b()}
function Of(a,b){b||(b=document);var c=gb(b.getElementsByTagName("yt:"+a));var d="yt-"+a;var e=b||document;d=e.querySelectorAll&&e.querySelector?e.querySelectorAll("."+d):tc(d,b);d=gb(d);return fb(c,d)}
function M(a,b){var c;"yt:"==a.tagName.toLowerCase().substr(0,3)?c=a.getAttribute(b):c=a?a.dataset?a.dataset[Jf(b)]:a.getAttribute("data-"+b):null;return c}
...
function O(a,b){for(var c=[a.g,window.YTConfig||{}],d=0;d<c.length;d++){var e=c[d][b];if(void 0!=e)return e}return null}
function Rf(a,b,c){wg||(wg={},Bf(window,"message",Xa(a.i,a)));wg[c]=b}
Qf.prototype.i=function(a){if(a.origin==O(this,"host")||a.origin==O(this,"host").replace(/^http:/,"https:")){try{var b=JSON.parse(a.data)}catch(c){return}this.h=!0;this.f||0!=a.origin.indexOf("https:")||(this.f=!0);if(a=wg[b.id])a.o=!0,a.o&&(E(a.m,a.V,a),a.m.length=0),a.ea(b)}};
...
function xg(a){var b=L("EXPERIMENTS_FORCED_FLAGS",{});return void 0!==b[a]?b[a]:L("EXPERIMENT_FLAGS",{})[a]}
;function zg(){}
...
Bg.g();var Cg=z.ytPubsubPubsubInstance||new K,Dg=z.ytPubsubPubsubSubscribedKeys||{},Eg=z.ytPubsubPubsubTopicToKeys||{},Fg=z.ytPubsubPubsubIsSynchronous||{};K.prototype.subscribe=K.prototype.subscribe;K.prototype.unsubscribeByKey=K.prototype.O;K.prototype.publish=K.prototype.I;K.prototype.clear=K.prototype.clear;C("ytPubsubPubsubInstance",Cg);C("ytPubsubPubsubTopicToKeys",Eg);C("ytPubsubPubsubIsSynchronous",Fg);C("ytPubsubPubsubSubscribedKeys",Dg);var Gg=window,T=Gg.ytcsi&&Gg.ytcsi.now?Gg.ytcsi.now:Gg.performance&&Gg.performance.timing&&Gg.performance.now&&Gg.performance.timing.navigationStart?function(){return Gg.performance.timing.navigationStart+Gg.performance.now()}:function(){return(new Date).getTime()};var Hg=yg("initial_gel_batch_timeout",1E3),Ig=Math.pow(2,16)-1,Jg=null,Kg=0,Lg=void 0,Mg=0,Ng=0,Og=0,Pg=!0,Qg=z.ytLoggingTransportGELQueue_||new Map;C("ytLoggingTransportGELQueue_",Qg);var Rg=z.ytLoggingTransportTokensToCttTargetIds_||{};C("ytLoggingTransportTokensToCttTargetIds_",Rg);function Sg(a){a=void 0===a?!1:a;return new J(function(b){window.clearTimeout(Mg);window.clearTimeout(Ng);Ng=0;Lg&&Lg.isReady()?(Tg(b,a),Qg.clear()):(Ug(),b())})}
function Ug(){S("web_gel_timeout_cap")&&!Ng&&(Ng=Cf(Sg,6E4));window.clearTimeout(Mg);var a=L("LOGGING_BATCH_TIMEOUT",yg("web_gel_debounce_ms",1E4));S("shorten_initial_gel_batch_timeout")&&Pg&&(a=Hg);Mg=Cf(Sg,a)}
function Tg(a,b){var c=Lg;b=void 0===b?!1:b;for(var d=Math.round(T()),e=Qg.size,f=u(Qg),g=f.next();!g.done;g=f.next()){var h=u(g.value);g=h.next().value;var k=h.next().value;h=sb({context:Vg(c.f||Wg())});h.events=k;(k=Rg[g])&&Xg(h,g,k);delete Rg[g];Yg(h,d);Zg(c,"log_event",h,{retry:!0,onSuccess:function(){e--;e||a();Kg=Math.round(T()-d)},
onError:function(){e--;e||a()},
ya:b});Pg=!1}}
function Yg(a,b){a.requestTimeMs=String(b);S("unsplit_gel_payloads_in_logs")&&(a.unsplitGelPayloadsInLogs=!0);var c=L("EVENT_ID",void 0);if(c){var d=L("BATCH_CLIENT_COUNTER",void 0)||0;!d&&S("web_client_counter_random_seed")&&(d=Math.floor(Math.random()*Ig/2));d++;d>Ig&&(d=1);of("BATCH_CLIENT_COUNTER",d);c={serializedEventId:c,clientCounter:String(d)};a.serializedClientEventId=c;Jg&&Kg&&S("log_gel_rtt_web")&&(a.previousBatchInfo={serializedClientEventId:Jg,roundtripMs:String(Kg)});Jg=c;Kg=0}}
...
z.document.createElementNS&&l.set(0);c=Hc();c["allow-top-navigation-by-user-activation"]&&l.set(1);c["allow-popups-to-escape-sandbox"]&&l.set(2);z.crypto&&z.crypto.subtle&&l.set(3);z.TextDecoder&&z.TextEncoder&&l.set(4);l=Tc(l);m.bc=l;m.bih=k.height;m.biw=k.width;m.brdim=b.join();a=a.g;return m.vis={visible:1,hidden:2,prerender:3,preview:4,unloaded:5}[a.visibilityState||a.webkitVisibilityState||a.mozVisibilityState||""]||0,m.wgl=!!H.WebGLRenderingContext,m}
...
function mh(a,b){b.Sa&&(a=document.location.protocol+"//"+document.location.hostname+(document.location.port?":"+document.location.port:"")+a);var c=L("XSRF_FIELD_NAME",void 0),d=b.wa;d&&(d[c]&&delete d[c],a=Hf(a,d||{},!0));return a}
function nh(a,b){var c=L("XSRF_FIELD_NAME",void 0),d=L("XSRF_TOKEN",void 0),e=b.postBody||"",f=b.u,g=L("XSRF_FIELD_NAME",void 0),h;b.headers&&(h=b.headers["Content-Type"]);b.Ra||yc(a)&&!b.withCredentials&&yc(a)!=document.location.hostname||"POST"!=b.method||h&&"application/x-www-form-urlencoded"!=h||b.u&&b.u[g]||(f||(f={}),f[c]=d);f&&"string"===typeof e&&(e=Gf(e),ub(e,f),e=b.da&&"JSON"==b.da?JSON.stringify(e):Bc(e));if(!(c=e)&&(c=f)){a:{for(var k in f){f=!1;break a}f=!0}c=!f}!ih&&c&&"POST"!=b.method&&
...
return e}
function th(a){if(B(a))for(var b in a){var c;(c="html_content"==b)||(c=b.length-5,c=0<=c&&b.indexOf("_html",c)==c);if(c){c=b;var d=a[b];if(void 0===vb){var e=null;var f=z.trustedTypes;if(f&&f.createPolicy){try{e=f.createPolicy("goog#html",{createHTML:Za,createScript:Za,createScriptURL:Za})}catch(g){z.console&&z.console.error(g.message)}vb=e}else vb=e}(e=vb)&&e.createHTML(d);a[c]=new Ib}else th(a[b])}}
...
return k}
;function uh(){for(var a={},b=u(Object.entries(Gf(L("DEVICE","")))),c=b.next();!c.done;c=b.next()){var d=u(c.value);c=d.next().value;d=d.next().value;"cbrand"===c?a.deviceMake=d:"cmodel"===c?a.deviceModel=d:"cbr"===c?a.browserName=d:"cbrver"===c?a.browserVersion=d:"cos"===c?a.osName=d:"cosver"===c?a.osVersion=d:"cplatform"===c&&(a.platform=d)}return a}
;function vh(){return"INNERTUBE_API_KEY"in nf&&"INNERTUBE_API_VERSION"in nf}
function Wg(){return{innertubeApiKey:L("INNERTUBE_API_KEY",void 0),innertubeApiVersion:L("INNERTUBE_API_VERSION",void 0),ma:L("INNERTUBE_CONTEXT_CLIENT_CONFIG_INFO"),na:L("INNERTUBE_CONTEXT_CLIENT_NAME","WEB"),innertubeContextClientVersion:L("INNERTUBE_CONTEXT_CLIENT_VERSION",void 0),pa:L("INNERTUBE_CONTEXT_HL",void 0),oa:L("INNERTUBE_CONTEXT_GL",void 0),qa:L("INNERTUBE_HOST_OVERRIDE",void 0)||"",sa:!!L("INNERTUBE_USE_THIRD_PARTY_AUTH",!1),ra:!!L("INNERTUBE_OMIT_API_KEY_WHEN_AUTH_HEADER_IS_PRESENT",
!1),appInstallData:L("SERIALIZED_CLIENT_CONFIG_DATA",void 0)}}
function Vg(a){var b={client:{hl:a.pa,gl:a.oa,clientName:a.na,clientVersion:a.innertubeContextClientVersion,configInfo:a.ma}},c=window.devicePixelRatio;c&&1!=c&&(b.client.screenDensityFloat=String(c));c=L("EXPERIMENTS_TOKEN","");""!==c&&(b.client.experimentsToken=c);c=[];var d=L("EXPERIMENTS_FORCED_FLAGS",{});for(e in d)c.push({key:e,value:String(d[e])});var e=L("EXPERIMENT_FLAGS",{});for(var f in e)f.startsWith("force_")&&void 0===d[f]&&c.push({key:f,value:String(e[f])});0<c.length&&(b.request={internalExperimentFlags:c});
a.appInstallData&&S("web_log_app_install_experiments")&&(b.client.configInfo=b.client.configInfo||{},b.client.configInfo.appInstallData=a.appInstallData);L("DELEGATED_SESSION_ID")&&!S("pageid_as_header_web")&&(b.user={onBehalfOfUser:L("DELEGATED_SESSION_ID")});b.client=Object.assign(b.client,uh());return b}
function wh(a,b,c){c=void 0===c?{}:c;var d={"X-Goog-Visitor-Id":c.visitorData||L("VISITOR_DATA","")};if(b&&b.includes("www.youtube-nocookie.com"))return d;(b=c.La||L("AUTHORIZATION"))||(a?b="Bearer "+A("gapi.auth.getToken")().Ka:b=Rc([]));b&&(d.Authorization=b,d["X-Goog-AuthUser"]=L("SESSION_INDEX",0),S("pageid_as_header_web")&&(d["X-Goog-PageId"]=L("DELEGATED_SESSION_ID")));return d}
;function xh(a){a=Object.assign({},a);delete a.Authorization;var b=Rc();if(b){var c=new id;c.update(L("INNERTUBE_API_KEY",void 0));c.update(b);b=c.digest();c=3;Oa(b);void 0===c&&(c=0);if(!lc){lc={};for(var d="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789".split(""),e=["+/=","+/","-_=","-_.","-_"],f=0;5>f;f++){var g=d.concat(e[f].split(""));kc[f]=g;for(var h=0;h<g.length;h++){var k=g[h];void 0===lc[k]&&(lc[k]=h)}}}c=kc[c];d=[];for(e=0;e<b.length;e+=3){var l=b[e],m=(f=e+1<b.length)?
...
function Dh(a){var b=Ah().get("requests",!0);if(b){for(var c in b){var d=b[c];if(!(6E4>Math.round(T())-d.requestTime)){var e=d.authState,f=xh(wh(!1));mb(e,f)&&(e=d.request,"requestTimeMs"in e&&(e.requestTimeMs=Math.round(T())),Zg(a,d.method,e,{}));delete b[c]}}Ah().set("requests",b,86400,!0)}}
;new I;var Eh=[],Fh=!1;function Gh(a,b){Fh||(Eh.push({type:"EVENT",eventType:a,payload:b}),10<Eh.length&&Eh.shift())}
...
function Oh(a){return new J(function(b,c){Nh(a,b,c)})}
function V(a){return new U(function(b,c){Nh(a,b,c)})}
...
w(Vh,Th);function Wh(a,b){this.f=a;this.options=b;this.transactionCount=0;this.h=Math.round(T());this.g=!1}
...
function Xh(a,b,c,d){c=void 0===c?"readonly":c;a.transactionCount++;var e=a.f.transaction(b,c);e=new Zh(e);d=$h(e,d);ai(a,d,b.join(),c);return d}
function ai(a,b,c,d){var e=Math.round(T());Ke(b.then(function(){var f=Math.round(T());bi(a,!0,c,f-e)}),function(f){var g=Math.round(T()),h=a.f.name,k=a.transactionCount,l;
"QuotaExceededError"===f.name?l=new Th("QUOTA_EXCEEDED",{objectStoreNames:c,dbName:h,mode:d}):"UnknownError"===f.name&&(l=new Th("QUOTA_MAYBE_EXCEEDED",{objectStoreNames:c,dbName:h,mode:d}));l&&Gh("QUOTA_EXCEEDED",{dbName:h,objectStoreNames:c,transactionCount:k,transactionMode:d});h=g-e;f instanceof Uh&&(Gh("TRANSACTION_UNEXPECTEDLY_ABORTED",{objectStoreNames:c,transactionDuration:h,transactionCount:a.transactionCount,dbDuration:g-a.h}),a.g=!0);bi(a,!1,c,h)})}
function bi(a,b,c,d){Gh("TRANSACTION_ENDED",{objectStoreNames:c,connectionHasUnknownAbortedTransaction:a.g,duration:d,isSuccessful:b})}
function ci(a){this.f=a}
p=ci.prototype;p.add=function(a,b){return V(this.f.add(a,b))};
...
p["delete"]=function(a){return a instanceof IDBKeyRange?di(this,a):V(this.f["delete"](a))};
...
function ei(a,b,c){a=a.f.openCursor(b.query,b.direction);return gi(a).then(function(d){return Ph(d,c)})}
function Zh(a){var b=this;this.f=a;this.g=new Map;this.aborted=!1;this.done=new J(function(c,d){b.f.addEventListener("complete",function(){c()});
...
function $h(a,b){var c=new J(function(d,e){Jh(b(a).then(function(f){a.commit();d(f)}),e)});
return Ie([c,a.done]).then(function(d){return u(d).next().value})}
Zh.prototype.abort=function(){this.f.abort();this.aborted=!0;throw new Th("EXPLICIT_ABORT");};
Zh.prototype.commit=function(){var a=this.f;a.commit&&!this.aborted&&a.commit()};
function Yh(a,b){var c=a.f.objectStore(b),d=a.g.get(c);d||(d=new ci(c),a.g.set(c,d));return d}
function fi(a){this.f=a}
fi.prototype.count=function(a){return V(this.f.count(a))};
fi.prototype["delete"]=function(a){return hi(this,{query:a},function(b){return b["delete"]().then(function(){return b["continue"]()})})};
fi.prototype.get=function(a){return V(this.f.get(a))};
fi.prototype.getKey=function(a){return V(this.f.getKey(a))};
function hi(a,b,c){a=a.f.openCursor(void 0===b.query?null:b.query,void 0===b.direction?"next":b.direction);return gi(a).then(function(d){return Ph(d,c)})}
function ii(a,b){this.request=a;this.cursor=b}
function gi(a){return V(a).then(function(b){return null===b?null:new ii(a,b)})}
p=ii.prototype;p.advance=function(a){this.cursor.advance(a);return gi(this.request)};
p["continue"]=function(a){this.cursor["continue"](a);return gi(this.request)};
p["delete"]=function(){return V(this.cursor["delete"]()).then(function(){})};
p.getKey=function(){return this.cursor.key};
p.update=function(a){return V(this.cursor.update(a))};function ji(a,b,c){function d(){m||(m=new Wh(e.result,{closed:l}));return m}
var e=self.indexedDB.open(a,b),f=c.blocked,g=c.blocking,h=c.va,k=c.upgrade,l=c.closed,m;e.addEventListener("upgradeneeded",function(n){if(null===n.newVersion)throw Error("Invariant: newVersion on IDbVersionChangeEvent is null");if(null===e.transaction)throw Error("Invariant: transaction on IDbOpenDbRequest is null");n.dataLoss&&"none"!==n.dataLoss&&Gh("IDB_DATA_CORRUPTED",{reason:n.dataLossMessage||"unknown reason",dbName:a});var r=d(),q=new Zh(e.transaction);k&&k(r,n.oldVersion,n.newVersion,q)});
...
;var mi=$b||jc;function ni(){var a=/WebKit\/([0-9]+)/.exec(Fb);return!!(a&&600<=parseInt(a[1],10))}
function oi(){var a=/WebKit\/([0-9]+)/.exec(Fb);return!!(a&&602<=parseInt(a[1],10))}
;function pi(a,b){for(var c=u(Object.keys(b.ua)),d=c.next();!d.done;d=c.next())if(d=d.value,!a.f.objectStoreNames.contains(d))return d}
function qi(a){this.name="YtIdbMeta";this.options=a;this.g=!1}
function ri(a,b,c){c=void 0===c?{}:c;return ki(a,b,c)}
qi.prototype["delete"]=function(a){a=void 0===a?{}:a;return li(this.name,a)};
qi.prototype.open=function(){var a=this;if(!this.f){var b,c=function(){a.f===b&&(a.f=void 0)},d={blocking:function(f){f.close()},
closed:c,va:c,upgrade:this.options.upgrade},e=function(){return Ke(ri(a.name,a.options.version,d).then(function(f){if(Zb){var g=pi(f,a.options);if(void 0!==g){if(Zb&&!a.g)return a.g=!0,a["delete"]().then(function(){return e()});
throw new Vh(g);}}return f}),function(f){if(f instanceof DOMException?"VersionError"===f.name:"DOMError"in self&&f instanceof DOMError?"VersionError"===f.name:f instanceof Object&&"message"in f&&"An attempt was made to open a database using a lower version than the existing version."===f.message)return ri(a.name,void 0,Object.assign(Object.assign({},d),{upgrade:void 0}));
c();throw f;})};
this.f=b=e()}return this.f};var si=new qi({ua:{databases:!0},upgrade:function(a,b){1>b&&a.f.createObjectStore("databases",{keyPath:"actualName"})}});
function ti(){var a={actualName:"yt-idb-test-do-not-use",publicName:"yt-idb-test-do-not-use",userIdentifier:void 0,signedIn:!1};return si.open().then(function(b){return Xh(b,["databases"],"readwrite",function(c){var d=Yh(c,"databases");return d.get(a.actualName).then(function(e){if(e?a.actualName!==e.actualName||a.publicName!==e.publicName||a.userIdentifier!==e.userIdentifier||a.signedIn!==e.signedIn||a.clearDataOnAuthChange!==e.clearDataOnAuthChange:1)return V(d.f.put(a,void 0))})})})}
function ui(){return si.open().then(function(a){return a["delete"]("databases","yt-idb-test-do-not-use")})}
;var vi;function wi(){return $a(this,function b(){var c,d;return Ja(b,function(e){switch(e.g){case 1:if(mi&&ni()&&!oi()&&!S("ytidb_allow_on_ios_safari_v8_and_v9")||Mb)return e["return"](!1);try{if(c=self,!(c.indexedDB&&c.IDBIndex&&c.IDBKeyRange&&c.IDBObjectStore))return e["return"](!1)}catch(f){return e["return"](!1)}if(S("ytidb_new_supported_check_with_delete"))return e["return"](new Promise(function(f){Ke(ui().then(function(){f(!0)}),function(){f(!1)})}));
if(S("ytidb_new_supported_check_with_add_and_delete"))return e["return"](new Promise(function(f){Ke(ti().then(function(){return ui()}).then(function(){f(!0)}),function(){f(!1)})}));
wa(e);return ua(e,Ke(ki("yt-idb-test-do-not-use"),function(){}));
case 5:if(d=e.o,!d)return e["return"](!1);case 3:ya(e);if(d)try{d.close()}catch(f){}za(e);break;case 2:return xa(e),e["return"](!1);case 4:return"IDBTransaction"in self&&"objectStoreNames"in IDBTransaction.prototype?e["return"](!0):e["return"](!1)}})})}
function xi(){if(void 0!==vi)return vi;var a=T();Fh=!0;return vi=new J(function(b){wi().then(function(c){Fh=!1;Gh("IS_SUPPORTED_COMPLETED",{duration:Math.round(T()-a),isSupported:c});b(c)})})}
;function yi(){I.call(this);this.g=zi();Ai(this);Bi(this)}
w(yi,I);function zi(){var a=window.navigator.onLine;return void 0===a?!0:a}
function Bi(a){window.addEventListener("online",function(){a.g=!0;a.o&&a.o()})}
function Ai(a){window.addEventListener("offline",function(){a.g=!1;a.m&&a.m()})}
;function Ci(a,b){b=void 0===b?{}:b;xi().then(function(){yi.f||(yi.f=new yi);yi.f.g!==zi()&&tf(new Qh("NetworkStatusManager isOnline does not match window status"));oh(a,b)})}
function Di(a,b){b=void 0===b?{}:b;xi().then(function(){oh(a,b)})}
;function Ei(a){var b=this;this.f=null;a?this.f=a:vh()&&(this.f=Wg());Ag(function(){Dh(b)})}
Ei.prototype.isReady=function(){!this.f&&vh()&&(this.f=Wg());return!!this.f};
...
timeout:d.timeout,withCredentials:!0},g="";(e=a.f.qa)&&(g=e);var h=a.f.sa||!1,k=wh(h,g,d);Object.assign(f.headers,k);f.headers.Authorization&&!g&&(f.headers["x-origin"]=window.location.origin);e="/youtubei/"+a.f.innertubeApiVersion+"/"+b;var l={alt:"json"};a.f.ra&&f.headers.Authorization||(l.key=a.f.innertubeApiKey);var m=Hf(""+g+e,l||{},!0);xi().then(function(n){if(d.retry&&S("retry_web_logging_batches")&&"www.youtube-nocookie.com"!=g){if(S("networkless_gel")&&!n||!S("networkless_gel"))var r=Bh(b,
c,k,h);if(r){var q=f.onSuccess,x=f.aa;f.onSuccess=function(v,F){Ch(r);q(v,F)};
c.aa=function(v,F){Ch(r);x(v,F)}}}try{S("use_fetch_for_op_xhr")?lh(m,f):S("networkless_gel")&&d.retry?(f.method="POST",!d.ya&&S("nwl_send_fast_on_unload")?Di(m,f):Ci(m,f)):(f.method="POST",f.u||(f.u={}),oh(m,f))}catch(v){if("InvalidAccessError"==v.name)r&&(Ch(r),r=0),tf(Error("An extension is blocking network request."));
...
groups:["key"]},{regexp:/\uac1c\uccb4\uac00 '([^']+)' \uc18d\uc131\uc774\ub098 \uba54\uc11c\ub4dc\ub97c \uc9c0\uc6d0\ud558\uc9c0 \uc54a\uc2b5\ub2c8\ub2e4./,groups:["key"]}]}}];function Gi(){this.f=[];this.g=[]}
var Hi;var Ii=new K;function Ji(a,b,c,d){c+="."+a;a=Ki(b);d[c]=a;return c.length+a.length}
function Ki(a){return("string"===typeof a?a:String(JSON.stringify(a))).substr(0,500)}
;var Li=new Set,Mi=0,Ni=["PhantomJS","Googlebot","TO STOP THIS SECURITY SCAN go/scan"];function Y(a,b,c){this.l=this.f=this.g=null;this.j=Pa(this);this.h=0;this.o=!1;this.m=[];this.i=null;this.v=c;this.G={};c=document;if(a="string"===typeof a?c.getElementById(a):a)if(c="iframe"==a.tagName.toLowerCase(),b.host||(b.host=c?zc(a.src):"https://www.youtube.com"),this.g=new Qf(b),c||(b=Oi(this,a),this.l=a,(c=a.parentNode)&&c.replaceChild(b,a),a=b),this.f=a,this.f.id||(this.f.id="widget"+Pa(this.f)),Kf[this.f.id]=this,window.postMessage){this.i=new K;Pi(this);b=O(this.g,"events");for(var d in b)b.hasOwnProperty(d)&&
this.addEventListener(d,b[d]);for(var e in Mf)Qi(this,e)}}
...
c.src=O(a.g,"host")+a.R()+"?"+Bc(h);return c}
p.ca=function(){this.f&&this.f.contentWindow?this.V({event:"listening"}):window.clearInterval(this.h)};
function Pi(a){Rf(a.g,a,a.j);a.h=Df(Xa(a.ca,a));Bf(a.f,"load",Xa(function(){window.clearInterval(this.h);this.h=Df(Xa(this.ca,this))},a))}
function Ri(a,b){a.G[b]||(a.G[b]=!0,Si(a,"addEventListener",[b]))}
p.V=function(a){a.id=this.j;a.channel="widget";var b=Be(a),c=this.g,d=zc(this.f.src||"");var e=0==d.indexOf("https:")?[d]:c.f?[d.replace("http:","https:")]:c.h?[d]:[d,d.replace("http:","https:")];if(this.f.contentWindow)for(var f=0;f<e.length;f++)try{this.f.contentWindow.postMessage(b,e[f])}catch(Sa){if(Sa.name&&"SyntaxError"==Sa.name){if(!(Sa.message&&0<Sa.message.indexOf("target origin ''"))){var g=void 0,h=void 0,k=Sa;h=void 0===h?{}:h;h.name=L("INNERTUBE_CONTEXT_CLIENT_NAME",1);h.version=L("INNERTUBE_CONTEXT_CLIENT_VERSION",
void 0);var l=h||{},m="WARNING";m=void 0===m?"ERROR":m;g=void 0===g?!1:g;if(k){if(S("console_log_js_exceptions")){var n=k,r=[];r.push("Name: "+n.name);r.push("Message: "+n.message);n.hasOwnProperty("params")&&r.push("Error Params: "+JSON.stringify(n.params));r.push("File name: "+n.fileName);r.push("Stacktrace: "+n.stack);window.console.log(r.join("\n"),n)}if((window&&window.yterr||g)&&!(5<=Mi)&&0!==k.sampleWeight){var q=k,x=l,v=mc(q),F=v.message||"Unknown Error",Fa=v.name||"UnknownError",P=v.stack||
q.f||"Not available";if(S("kevlar_js_fixes")&&P.startsWith(Fa+": "+F)){var va=P.split("\n");va.shift();P=va.join("\n")}var Yi=v.lineNumber||"Not available",Zi=v.fileName||"Not available",$i=P,ac=void 0,ea=q,Q=x;if(ea.hasOwnProperty("args")&&ea.args&&ea.args.length)for(var ra=0,bc=0;bc<ea.args.length;bc++){var R=ea.args[bc],Aa="params."+bc;ra+=Aa.length;if(R)if(Array.isArray(R)){for(var aj=Q,md=ra,nb=0;nb<R.length&&!(R[nb]&&(md+=Ji(nb,R[nb],Aa,aj),500<md));nb++);ra=md}else if("object"===typeof R){var cc=
void 0,bj=Q,nd=ra;for(cc in R)if(R[cc]&&(nd+=Ji(cc,R[cc],Aa,bj),500<nd))break;ra=nd}else Q[Aa]=Ki(R),ra+=Q[Aa].length;else Q[Aa]=Ki(R),ra+=Q[Aa].length;if(500<=ra)break}else if(ea.hasOwnProperty("params")&&ea.params){var dc=ea.params;if("object"===typeof ea.params){var Sf=0;for(ac in dc)if(dc[ac]){var Tf="params."+ac,Uf=Ki(dc[ac]);Q[Tf]=Uf;Sf+=Tf.length+Uf.length;if(500<Sf)break}}else Q.params=Ki(dc)}navigator.vendor&&!Q.hasOwnProperty("vendor")&&(Q.vendor=navigator.vendor);var od={message:F,name:Fa,
lineNumber:Yi,fileName:Zi,stack:$i,params:Q},Vf=Number(q.columnNumber);isNaN(Vf)||(od.lineNumber=od.lineNumber+":"+Vf);for(var W,Ba=od,Wf=u(Fi),pd=Wf.next();!pd.done;pd=Wf.next()){var qd=pd.value;if(qd.U[Ba.name])for(var Xf=u(qd.U[Ba.name]),rd=Xf.next();!rd.done;rd=Xf.next()){var Yf=rd.value,ec=Ba.message.match(Yf.regexp);if(ec){Ba.params["error.original"]=ec[0];for(var sd=Yf.groups,Zf={},Ta=0;Ta<sd.length;Ta++)Zf[sd[Ta]]=ec[Ta+1],Ba.params["error."+sd[Ta]]=ec[Ta+1];Ba.message=qd.Z(Zf);break}}}W=
Ba;window.yterr&&"function"===typeof window.yterr&&window.yterr(W);if(!(Li.has(W.message)||0<=W.stack.indexOf("/YouTubeCenter.js")||0<=W.stack.indexOf("/mytube.js"))){"ERROR"===m?Ii.I("handleError",W):"WARNING"===m&&Ii.I("handleWarning",W);if(S("kevlar_gel_error_routing")){var fc=void 0,$f=m,N=W;a:{for(var ag=u(Ni),td=ag.next();!td.done;td=ag.next()){var bg=Fb;if(bg&&0<=bg.toLowerCase().indexOf(td.value.toLowerCase())){var cg=!0;break a}}cg=!1}if(!cg){var ob={stackTrace:N.stack};N.fileName&&(ob.filename=
N.fileName);var fa=N.lineNumber&&N.lineNumber.split?N.lineNumber.split(":"):[];0!==fa.length&&(1!==fa.length||isNaN(Number(fa[0]))?2!==fa.length||isNaN(Number(fa[0]))||isNaN(Number(fa[1]))||(ob.lineNumber=Number(fa[0]),ob.columnNumber=Number(fa[1])):ob.lineNumber=Number(fa[0]));Hi||(Hi=new Gi);var gc=Hi;var cj=N.message,dj=N.name;a:{for(var dg=u(gc.g),ud=dg.next();!ud.done;ud=dg.next()){var eg=ud.value;if(N.message&&N.message.match(eg.f)){var vd=eg.weight;break a}}for(var fg=u(gc.f),wd=fg.next();!wd.done;wd=
fg.next()){var gg=wd.value;if(gg.f(N)){vd=gg.weight;break a}}vd=1}var xd={level:"ERROR_LEVEL_UNKNOWN",message:cj,errorClassName:dj,sampleWeight:vd};"ERROR"===$f?xd.level="ERROR_LEVEL_ERROR":"WARNING"===$f&&(xd.level="ERROR_LEVEL_WARNNING");var ej={isObfuscated:!0,browserStackInfo:ob},Ua={pageUrl:window.location.href};L("FEXP_EXPERIMENTS")&&(Ua.experimentIds=L("FEXP_EXPERIMENTS"));Ua.kvPairs=[{key:"client.params.errorServiceSignature",value:"msg="+gc.g.length+"&cb="+gc.f.length},{key:"client.params.serviceWorker",
value:"false"}];var yd=N.params;if(yd)for(var hg=u(Object.keys(yd)),zd=hg.next();!zd.done;zd=hg.next()){var ig=zd.value;Ua.kvPairs.push({key:"client."+ig,value:String(yd[ig])})}var jg=L("SERVER_NAME",void 0),kg=L("SERVER_VERSION",void 0);jg&&kg&&(Ua.kvPairs.push({key:"server.name",value:jg}),Ua.kvPairs.push({key:"server.version",value:kg}));var fj={errorMetadata:Ua,stackTrace:ej,logMessage:xd};fc=void 0===fc?{}:fc;var lg=Ei;L("ytLoggingEventsDefaultDisabled",!1)&&Ei==Ei&&(lg=null);var gj=lg,X=fc;
X=void 0===X?{}:X;var pb={};pb.eventTimeMs=Math.round(X.timestamp||T());pb.clientError=fj;var mg=A("_lact",window);var ng=null==mg?-1:Math.max(Date.now()-mg,0);pb.context={lastActivityMs:String(X.timestamp||!isFinite(ng)?-1:ng)};if(S("log_sequence_info_on_gel_web")&&X.fa){var hj=pb.context,qb=X.fa;$g[qb]=qb in $g?$g[qb]+1:0;hj.sequence={index:$g[qb],groupKey:qb};X.Qa&&delete $g[X.fa]}var ij=pb,hc=X.Pa,og=gj,Ad="";if(hc){var ic=hc,Bd={};ic.videoId?Bd.videoId=ic.videoId:ic.playlistId&&(Bd.playlistId=
ic.playlistId);Rg[hc.token]=Bd;Ad=hc.token}var Cd=Qg.get(Ad)||[];Qg.set(Ad,Cd);Cd.push(ij);og&&(Lg=new og);var jj=yg("web_logging_max_batch")||100,pg=T();Cd.length>=jj?Sg(!0):10<=pg-Og&&(Ug(),Og=pg);Sg()}}if(!S("suppress_error_204_logging")){var Dd,Ca=W,rb=Ca.params||{},sa={wa:{a:"logerror",t:"jserror",type:Ca.name,msg:Ca.message.substr(0,250),line:Ca.lineNumber,level:m,"client.name":rb.name},u:{url:L("PAGE_NAME",window.location.href),file:Ca.fileName},method:"POST"};rb.version&&(sa["client.version"]=
rb.version);if(sa.u){Ca.stack&&(sa.u.stack=Ca.stack);for(var qg=u(Object.keys(rb)),Ed=qg.next();!Ed.done;Ed=qg.next()){var rg=Ed.value;sa.u["client."+rg]=rb[rg]}if(Dd=L("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS",void 0))for(var sg=u(Object.keys(Dd)),Fd=sg.next();!Fd.done;Fd=sg.next()){var tg=Fd.value;sa.u[tg]=Dd[tg]}var ug=L("SERVER_NAME",void 0),vg=L("SERVER_VERSION",void 0);ug&&vg&&(sa.u["server.name"]=ug,sa.u["server.version"]=vg)}oh(L("ECATCHER_REPORT_HOST","")+"/error_204",sa)}Li.add(W.message);
Mi++}}}}}else throw Sa;}else console&&console.warn&&console.warn("The YouTube player is not attached to the DOM. API calls should be made after the onReady event. See more: https://developers.google.com/youtube/iframe_api_reference#Events")};function Ti(a){return(0===a.search("cue")||0===a.search("load"))&&"loadModule"!==a}
function Ui(a){return 0===a.search("get")||0===a.search("is")}
...
w(Z,Y);p=Z.prototype;p.R=function(){return"/embed/"+O(this.g,"videoId")};
p.P=function(){var a=O(this.g,"playerVars");if(a){var b={},c;for(c in a)b[c]=a[c];a=b}else a={};window!=window.top&&document.referrer&&(a.widget_referrer=document.referrer.substring(0,256));if(c=O(this.g,"embedConfig")){if(B(c))try{c=JSON.stringify(c)}catch(d){console.error("Invalid embed config JSON",d)}a.embed_config=c}return a};
p.ea=function(a){var b=a.event;a=a.info;switch(b){case "apiInfoDelivery":if(B(a))for(var c in a)this.C[c]=a[c];break;case "infoDelivery":Vi(this,a);break;case "initialDelivery":window.clearInterval(this.h);this.playerInfo={};this.C={};Wi(this,a.apiInterface);Vi(this,a);break;default:this.N(b,a)}};
function Vi(a,b){if(B(b))for(var c in b)a.playerInfo[c]=b[c]}
function Wi(a,b){E(b,function(c){this[c]||("getCurrentTime"==c?this[c]=function(){var d=this.playerInfo.currentTime;if(1==this.playerInfo.playerState){var e=(Date.now()/1E3-this.playerInfo.currentTimeLastUpdated_)*this.playerInfo.playbackRate;0<e&&(d+=Math.min(e,1))}return d}:Ti(c)?this[c]=function(){this.playerInfo={};
this.C={};Si(this,c,arguments);return this}:Ui(c)?this[c]=function(){var d=0;
0===c.search("get")?d=3:0===c.search("is")&&(d=2);return this.playerInfo[c.charAt(d).toLowerCase()+c.substr(d+1)]}:this[c]=function(){Si(this,c,arguments);
return this})},a)}
p.getVideoEmbedCode=function(){var a=parseInt(O(this.g,"width"),10),b=parseInt(O(this.g,"height"),10),c=O(this.g,"host")+this.R();Db.test(c)&&(-1!=c.indexOf("&")&&(c=c.replace(xb,"&amp;")),-1!=c.indexOf("<")&&(c=c.replace(yb,"&lt;")),-1!=c.indexOf(">")&&(c=c.replace(zb,"&gt;")),-1!=c.indexOf('"')&&(c=c.replace(Ab,"&quot;")),-1!=c.indexOf("'")&&(c=c.replace(Bb,"&#39;")),-1!=c.indexOf("\x00")&&(c=c.replace(Cb,"&#0;")));return'<iframe width="'+a+'" height="'+b+'" src="'+c+'" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>'};
...
function Xi(a){if("iframe"!=a.tagName.toLowerCase()){var b=M(a,"videoid");b&&(b={videoId:b,width:M(a,"width"),height:M(a,"height")},new Z(a,b))}}
;function kj(a,b){var c={title:"Thumbnail",videoId:"",width:120,height:68};if(b)for(var d in b)c[d]=b[d];Y.call(this,a,c,"thumbnail")}
w(kj,Y);kj.prototype.R=function(){return"/embed/"+O(this.g,"videoId")};
kj.prototype.P=function(){return{player:0,thumb_width:O(this.g,"thumbWidth"),thumb_height:O(this.g,"thumbHeight"),thumb_align:O(this.g,"thumbAlign")}};
kj.prototype.N=function(a,b){Y.prototype.N.call(this,a,b?b.info:void 0)};
function lj(a){if("iframe"!=a.tagName.toLowerCase()){var b=M(a,"videoid");if(b){b={videoId:b,events:{},width:M(a,"width"),height:M(a,"height"),thumbWidth:M(a,"thumb-width"),thumbHeight:M(a,"thumb-height"),thumbAlign:M(a,"thumb-align")};var c=M(a,"onclick");c&&(b.events.onClick=c);new kj(a,b)}}}
...
C("YT.scan",Nf);C("YT.subscribe",function(a,b,c){We.subscribe(a,b,c);Mf[a]=!0;for(var d in Kf)Qi(Kf[d],a)});
C("YT.unsubscribe",function(a,b,c){Ve(a,b,c)});
C("YT.Player",Z);C("YT.Thumbnail",kj);Y.prototype.destroy=Y.prototype.destroy;Y.prototype.setSize=Y.prototype.setSize;Y.prototype.getIframe=Y.prototype.ta;Y.prototype.addEventListener=Y.prototype.addEventListener;Z.prototype.getVideoEmbedCode=Z.prototype.getVideoEmbedCode;Z.prototype.getOptions=Z.prototype.getOptions;Z.prototype.getOption=Z.prototype.getOption;Lf.push(function(a){a=Of("player",a);E(a,Xi)});
Lf.push(function(){var a=Of("thumbnail");E(a,lj)});
"undefined"!=typeof YTConfig&&YTConfig.parsetags&&"onload"!=YTConfig.parsetags||Nf();var mj=z.onYTReady;mj&&mj();var nj=z.onYouTubeIframeAPIReady;nj&&nj();var oj=z.onYouTubePlayerAPIReady;oj&&oj();}).call(this);
